...
<div class="main--content">
   ...
   <div class="payment-card m-3" style=" background-color:lightcoral;">
    <h2 align="center">Add College</h2>
    <form action="collegecode.php" method="post">
    <table cellpadding="20px">
        <tr>
          <td class="session1"><input type="text" name="college" placeholder="Add College " style="text-align:center; width:250px; height:30px; border-radius:20px;"/></td></tr>
        <tr>
          <td class="session1"><input type="submit" value="Add" style="width:120px; margin-top:20px;"/></td><tr>
        </table>
    </form>
   </div>
   <div class="admin-view py-4 m-3 text-center">
    <table class="table-bordered p-1 m-0 table table-danger table-striped">
        <tr>
            <th>S.No</th>
