...
$query="select * from tbl_complaintype order by ctid";
...
<div class="main--content">
   ...
   <div class="payment-card m-3" style="background-color:lightcoral;">
    <h2 align="center">Add Complain Type</h2>
    <form action="complaincode.php" method="post">
    <table cellpadding="20px">
        <tr>
          <td class="session1"><input type="text" name="complain" placeholder="Add Complain Type " style="text-align:center; width:250px; height:30px; border-radius:20px;"/></td></tr>
        <tr>
          <td class="session1"><input type="submit" value="Add" style="width:120px; margin-top:20px;"/></td><tr>
        </table>
    </form>
   </div>
   <div class="admin-view py-4 m-3 text-center" style="width:900px; height:320px;">
    <table class=" table-bordered p-1 table table-danger table-striped" style="font-size:12px;">
        <tr>
            <th>S.No</th>
            <th>Complain Type</th>
